...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: '𝙎𝙂👺', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/clan_sport.gang/'}}}}, aa);
